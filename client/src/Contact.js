...
render(){
    return(
        <div className = "contact">
            ...
            <h1 className = 'h3'> Completati formularul de pe pagina Cautã ca sã fiti contactat direct de farmaciile locale care oferã produsul.</h1>
            <h1 className = 'h3'> Farmaciile din reteaua noastrã asteaptã mesajul dumneavoastrã !</h1>
            <h1 className = 'h3'>Pentru informatii despre reteaua noastã sau parteneriat conactati: <br/><br/>Cristian Lazar <br/> Telefon: 0773853041</h1>
        </div>
    )
}
}
