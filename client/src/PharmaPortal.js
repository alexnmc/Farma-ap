...
class PharmaPortal extends Component {
    ...
    componentDidMount(){
        this.props.user.username !== "cristianlazar2000@yahoo.com" || "uj_rudi@hotmail.com" ? this.props.getMessages(this.state.userCity) : this.props.getAllMessage()
    }
            ...
            <div className = 'pharmaport'>
                <div className = 'messageWrap'>
                    ...
                    <div className = 'portalWrap'>
                        {this.props.user.username === "cristianlazar2000@yahoo.com" || "uj_rudi@hotmail.com" ?
                            ...
                            :
                                ...
                                {this.props.messages.length ?
                                    <div className = "scrollDiv">
                                        {this.props.user.username === "cristianlazar2000@yahoo.com" || "uj_rudi@hotmail.com" ? admin : messages}
